...
BVE Trainsim の詳細なインストール方法については、初心者向けのガイドなどを参照してください。
ここでは特に注意すべき点のみ記載します。
...
JRTrainPack は、多数の列車データとプラグインを含む統合パッケージです。
...
各駅間の距離は、作者独自の設定であり、
原作（東方 Project）とは関係ありません。
また、幻想郷の規模に関する他者の解釈とも一致しない可能性があります。
...
最高速度は 120km/h。swp2 対応シナリオでは、高性能振り子車両（R600 +35km/h）が使用可能です。
...
※15M は **通常特急車両（非振り子）** のダイヤを使用しています。
